...
namespace DATN_BackEndApi.Controllers
{
    ...
    public class RoomTypeController : ControllerBase
    {
        ...
        public async Task<CommonResponse<dynamic>> CreateRoomType(string rq)
        {
            var res = new CommonResponse<dynamic>();

            _roomTypeDAO.CreateRoomType(rq, out int response);
            res.Data = null;
        ...
        public async Task<CommonResponse<dynamic>> DeleteRoomType(Guid id)
        {

            var res = new CommonResponse<dynamic>();
           _roomTypeDAO.DeleteRoomType(id, out int response);
            res.Data = null;
            res.Message = MessageUtils.GetMessage(response, _langCode);
            res.ResponseCode = response;
            return res;
